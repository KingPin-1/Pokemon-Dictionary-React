...
const Layout = () => {
  return (
    <div className="font-mono flex min-h-screen w-full flex-col dark:text-white">
      <header className="bg-slate-200 p-4 text-center text-2xl font-semibold dark:bg-slate-800 sm:text-4xl ">
        POKEMON DICTIONARY
      </header>
